  ...
  async execute(interaction, client) {
    ...
    if (i.options.getSubcommand() === "setup") {
      ...
      container.addTextDisplayComponents(
        new TextDisplayBuilder().setContent(`Press 📩 to Create a Ticket`)
      );
      ...
      switch (DelOptions) {
        case "setup": {
          if (!TicketSetupDB) {
            ...
            const container = new ContainerBuilder();
            container.addTextDisplayComponents(
              new TextDisplayBuilder().setContent(`Ticket setup has been deleted`)
            );
        ...
        case "tickets": {
          if (!TicketsDB) {
            ...
            const container = new ContainerBuilder();
            container.addTextDisplayComponents(
              new TextDisplayBuilder().setContent(`Tickets has been deleted`)
            );
        ...
        case "count": {
          if (!TicketCountDB) {
            ...
            const container = new ContainerBuilder();
            container.addTextDisplayComponents(
              new TextDisplayBuilder().setContent(`Ticket count has been deleted`)
            );
