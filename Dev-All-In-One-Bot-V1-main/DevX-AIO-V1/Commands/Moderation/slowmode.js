      ...
      subcommand
        ...
        .addIntegerOption((option) =>
          option
            .setName("time")
            .setDescription(
              "The time in seconds to set the slowmode of the channel to"
            )
            .setRequired(true)
            .setMinValue(1)
        )
        .addStringOption((option) =>
          option
            .setName("timeformat")
            .setDescription(
              "The time format to set the slowmode of the channel to"
            )
            .addChoices(
  ...
  async execute(interaction, client) {
    ...
    switch (interaction.options.getSubcommand()) {
      case "set":
        ...
        interaction.reply({
          content: `Slowmode of ${channel} has been set to ${time} ${timeformat}`,
          ephemeral: true,
        });
        break;
      case "disable":
        ...
        interaction.reply({
          content: `Slowmode of ${channel} has been disabled`,
          ephemeral: true,
        });
        break;
    }
